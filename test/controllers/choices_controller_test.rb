...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post choices_url, params: { choice: { chosen: @choice.chosen, name: @choice.name } }, as: :json
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { chosen: @choice.chosen, name: @choice.name } }, as: :json
    assert_response 200
  end
